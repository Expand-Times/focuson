      ...
      <View className="flex-1 px-6 pt-8">
        ...
        <View className="flex-1 items-center justify-center">
          ...
          <View className="mt-4 items-center">
            ...
            <Text allowFontScaling={false} className="px-2 text-center text-[12px] font-regular leading-6 text-[#8698B2]">
              Use at least <Text className="font-medium text-[#8698B2]">7 days</Text>, You're going to Love This App
            </Text>
          </View>
          ...
          <View className="">
            ...
            <View className="relative items-center justify-center">
              <Image source={require('@/assets/images/66.png')} className="h-[450px] w-[380px]" />
            </View>
          </View>

          {/* Description Text - Moved here */}
          <View>
            <Text allowFontScaling={false} className="mb-4 px-4 text-center text-[12px] font-light leading-5 text-[#8698B2]">
              Give it only a week, and you'll discover why this is{'\n'}
              your must-have app.
            </Text>

            <Text allowFontScaling={false} className="px-8 text-center text-[12px] font-light leading-4 text-[#8698B2]">
        ...
        <View className="w-full items-center pb-8 pt-4">
          ...
          <View className="mb-8 flex-row space-x-3">
            {[...Array(6)].map((_, i) => (
              <View
                key={i}
                className={`h-[18px] w-[18px] rounded-full border border-blue-400 mx-1 ${i <= 5 ? 'bg-blue-400' : 'bg-transparent'}`}
              />
            ))}
          </View>
