...
export const AVAILABLE_WALLPAPERS: WallpaperItem[] = [
  ...
  require('../../assets/Wallpaper/11.jpg'),
  require('../../assets/Wallpaper/12.jpg'),
  require('../../assets/Wallpaper/13.jpg'),
  ...
  require('../../assets/Wallpaper/18.jpg'),
  require('../../assets/Wallpaper/19.jpg'),
  require('../../assets/Wallpaper/20.jpg'),
