...
//     private var timerPillView: View? = null
//     private var timerPillTextView: TextView? = null
...
//         val remainingMs = limitMs - usageDelta
        
//         if (timerPillView == null && overlayView == null) {
//             showTimerPill()
//         }
        
//         if (overlayView == null) {
//             updateTimerPill(remainingMs)
//         }
...
//                 shape.setColor(Color.parseColor("#CC000000")) // Semi-transparent black
...
//             timerPillTextView = TextView(context).apply {
//                 textSize = 14f
//                 setTextColor(Color.WHITE)
//                 typeface = android.graphics.Typeface.DEFAULT_BOLD
//                 gravity = Gravity.CENTER
//             }
//             pillLayout.addView(timerPillTextView)
            
//             timerPillView = pillLayout
...
//             layoutParams.y = 50 // Margin from top
            
//             windowManager?.addView(timerPillView, layoutParams)
//         } catch (e: Exception) {
//             e.printStackTrace()
//         }
//     }

//     private fun updateTimerPill(remainingMs: Long) {
//         if (timerPillTextView == null) return
        
//         val seconds = Math.max(0, TimeUnit.MILLISECONDS.toSeconds(remainingMs))
//         val min = seconds / 60
//         val sec = seconds % 60
//         val text = String.format("%02d:%02d", min, sec)
        
//         timerPillTextView?.text = text
        
//         // Change color if running low (e.g. last 1 minute)
//         if (seconds < 60) {
//              timerPillTextView?.setTextColor(Color.parseColor("#EF4444")) // Red-500
//         } else {
//              timerPillTextView?.setTextColor(Color.WHITE)
//         }
//     }

//     private fun removeTimerPill() {
//         if (timerPillView != null) {
//             try {
//                 windowManager?.removeView(timerPillView)
//             } catch (e: Exception) {
//                 e.printStackTrace()
//             }
//             timerPillView = null
//             timerPillTextView = null
//         }
//     }
